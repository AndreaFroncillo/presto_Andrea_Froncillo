<div class="card mx-auto card-w shadow text-center mb-3">
    <img src="{{$article->images->IsNotEmpty() ? Storage::url($article->images->first()->path) : 'https://picsum.photos/200'}}" class="card-img-top" alt="{{ __('ui.article_image_alt') }} {{$article->title}}">
    <div class="card-body">
